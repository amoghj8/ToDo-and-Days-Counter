...
$(".main").append('<div class="times">'+'<div class="row">'+'<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">'+'<input type="text" name="" id="input" class="form-control todo" value="" required="required" pattern="" title=""></div>'+'<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3"><i class="fa fa-times fa-2x" aria-hidden="true"></i>'+'</div>'+'</div>'+'</div>');
